        ...
        <div class="row g-4">
            ...
            <div class="col-md-7">
                <div class="card border-0 rounded-5 p-4 shadow-lg" style="background: #0f172a; border: 1px solid rgba(245, 158, 11, 0.2) !important;">
                    ...
                    @for($i = 1; $i <= 4; $i++)
                        ...
                        <div class="mb-4 p-3 rounded-4" style="background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05);">
                            ...
                            <div class="row g-3 align-items-center">
                                ...
                                <div class="col-md-6">
                                    <label class="text-secondary small fw-bold uppercase">
                                        Template {{ $i }} Name
                                    </label>

                                    <input type="text"
                                           name="contract_{{ $i }}_name"
                                           class="form-control premium-input mt-1"
                                           value="{{ $company->$nameField }}"
                                           placeholder="e.g. Residential Painting Contract">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="file"
                                           name="contract_{{ $i }}_file"
                                           class="form-control premium-input mt-1">

                                    @if($company->$pathField)
                                        <div class="mt-2 text-success small fw-bold">
                                            <i class="fa-solid fa-circle-check"></i> File Active
                                        </div>

                                        <a href="{{ asset('storage/'.$company->$pathField) }}"
                                           target="_blank"
                                           class="text-info small fw-bold d-block mt-1">
                                            View Contract
                                        </a>
                                    @endif
                                </div>
                    ...
                    <button type="submit" class="btn btn-warning w-100 fw-900 text-dark py-3 shadow-lg mt-2">
