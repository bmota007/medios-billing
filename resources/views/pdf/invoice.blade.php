...
<div class="wrapper">
    ...
    <div class="header">
        <div class="title-container">
            ...
            <div class="muted">Date: {{ date('M d, Y', strtotime($invoice->invoice_date ?? now())) }}</div>
            @if($invoice->due_date && $invoice->status !== 'paid')
                <div class="muted">Due Date: {{ date('M d, Y', strtotime($invoice->due_date)) }}</div>
            @endif
        </div>
    ...
    <div style="width: 100%;">
        <div class="payment-status-card">
            @if($invoice->status === 'paid')
                ...
                <span class="muted">Date: {{ $invoice->paid_at ?? now() }}</span><br>
